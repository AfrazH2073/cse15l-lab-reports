...
Afraz TA - "Hey Akhil, Run a print statement that prints list1 and result after each iteration of the first while loop and see how it changes over time. Sincerely, Afraz"
...
Correct code after fixing the bug:
